        ...
        try:
            ...
            while True:
                ...
                for _ in range(screen_size * screen_size):
                    ...
                    for line in pprint(render_frame(A, B, screen_size, theta_spacing, phi_spacing)):
                        win32file.WriteFile(handle, str.encode(line))
                        win32file.WriteFile(handle, str.encode("\n"))
